...

{
  ...
  "critics": [
    {
      "name": "架空のコメンテーター名（例：田中一郎、鈴木花子など、実在しない日本人名）",
      "role": "専門分野の肩書き（例：臨床心理士、言語分析家、コミュニケーション研究者、行動経済学者など）",
...
criticsは必ず3人生成。それぞれ異なる専門分野（心理学・言語学・社会学など）から分析すること。名前は必ず日本人風の架空の氏名にすること。
重要: JSONのみ返すこと。`;
